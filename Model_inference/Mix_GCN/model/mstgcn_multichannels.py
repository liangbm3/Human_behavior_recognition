...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=3,
        ...
        self.joint_l1 = TCN_GCN_unit(in_channels, 64, A, residual=False, adaptive=adaptive)
        self.joint_l2 = TCN_GCN_unit(64, 64, A, residual=False, adaptive=adaptive)
        self.joint_l3 = TCN_GCN_unit(64, 128, A, stride=2, adaptive=adaptive)
        self.joint_l4 = TCN_GCN_unit(128, 128, A, adaptive=adaptive)
        self.joint_l5 = TCN_GCN_unit(128, 128, A, residual=False, adaptive=adaptive)
        self.joint_l6 = TCN_GCN_unit(128, 256, A, stride=2, adaptive=adaptive)
        self.joint_l7 = TCN_GCN_unit(256, 64, A, adaptive=adaptive)
        ...
        self.bone_l1 = TCN_GCN_unit(in_channels, 64, A, residual=False, adaptive=adaptive)
        self.bone_l2 = TCN_GCN_unit(64, 64, A, residual=False, adaptive=adaptive)
        self.bone_l3 = TCN_GCN_unit(64, 128, A, stride=2, adaptive=adaptive)
        self.bone_l4 = TCN_GCN_unit(128, 128, A, adaptive=adaptive)
        self.bone_l5 = TCN_GCN_unit(128, 128, A, residual=False, adaptive=adaptive)
        self.bone_l6 = TCN_GCN_unit(128, 256, A, stride=2, adaptive=adaptive)
        self.bone_l7 = TCN_GCN_unit(256, 64, A, adaptive=adaptive)
        ...
        self.jointmotion_l1 = TCN_GCN_unit(in_channels, 64, A, residual=False, adaptive=adaptive)
        self.jointmotion_l2 = TCN_GCN_unit(64, 64, A, residual=False, adaptive=adaptive)
        self.jointmotion_l3 = TCN_GCN_unit(64, 128, A, stride=2, adaptive=adaptive)
        self.jointmotion_l4 = TCN_GCN_unit(128, 128, A, adaptive=adaptive)
        self.jointmotion_l5 = TCN_GCN_unit(128, 128, A, residual=False, adaptive=adaptive)
        self.jointmotion_l6 = TCN_GCN_unit(128, 256, A, stride=2, adaptive=adaptive)
        self.jointmotion_l7 = TCN_GCN_unit(256, 64, A, adaptive=adaptive)
        ...
        self.bonemotion_l1 = TCN_GCN_unit(in_channels, 64, A, residual=False, adaptive=adaptive)
        self.bonemotion_l2 = TCN_GCN_unit(64, 64, A, residual=False, adaptive=adaptive)
        self.bonemotion_l3 = TCN_GCN_unit(64, 128, A, stride=2, adaptive=adaptive)
        self.bonemotion_l4 = TCN_GCN_unit(128, 128, A, adaptive=adaptive)
        self.bonemotion_l5 = TCN_GCN_unit(128, 128, A, residual=False, adaptive=adaptive)
        self.bonemotion_l6 = TCN_GCN_unit(128, 256, A, stride=2, adaptive=adaptive)
        self.bonemotion_l7 = TCN_GCN_unit(256, 64, A, adaptive=adaptive)
    ...
    def forward(self, x):
        ...
        joint = self.joint_l6(joint)
        bone = self.bone_l6(bone)
        jointmotion = self.jointmotion_l6(jointmotion)
        bonemotion = self.bonemotion_l6(bonemotion)

        joint = self.joint_l7(joint)
        bone = self.bone_l7(bone)
        jointmotion = self.jointmotion_l7(jointmotion)
        bonemotion = self.bonemotion_l7(bonemotion)
        ...
        # 前向传播中
        joint_bone = self.cross_attention_1(joint, bone)
        joint_jointmotion = self.cross_attention_2(joint, jointmotion)
        joint_bonemotion = self.cross_attention_3(joint, bonemotion)

        bone_jointmotion = self.cross_attention_4(bone, jointmotion)
        bone_bonemotion = self.cross_attention_5(bone, bonemotion)

        jointmotion_bonemotion = self.cross_attention_6(jointmotion, bonemotion)
        ...
        # 可学习权重加权融合
        fusion = self.weight1 * joint_bone + self.weight2 * joint_jointmotion + self.weight3 * joint_bonemotion \
            + self.weight4 * bone_jointmotion + self.weight5 * bone_bonemotion + self.weight6 * jointmotion_bonemotion
        # fusion = self.weight1 * joint + self.weight2 * bone + self.weight3 * jointmotion + self.weight4 * bonemotion
