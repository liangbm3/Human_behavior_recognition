...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=17, num_person=2, graph=None, graph_args=dict(), in_channels=3,
        ...
        if 1:
            ...
            self.l5 = TCN_GCN_unit(32, 64, A, stride=2, adaptive=adaptive, attention=attention)
            self.l6 = TCN_GCN_unit(64, 64, A, adaptive=adaptive, attention=attention)
            self.l7 = TCN_GCN_unit(64, 64, A, adaptive=adaptive, attention=attention)
            self.l8 = TCN_GCN_unit(64, 128, A, stride=2, adaptive=adaptive, attention=attention)
            self.l9 = TCN_GCN_unit(128, 128, A, adaptive=adaptive, attention=attention)
            self.l10 = TCN_GCN_unit(128, 128, A, adaptive=adaptive, attention=attention)
            output_emb = 128

        self.emb_dim = num_point * 128
