...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=3,
        ...
        self.joint_l1 = TCN_GCN_unit(in_channels, 64, A, residual=False, adaptive=adaptive)
        self.joint_l2 = TCN_GCN_unit(64, 128, A, adaptive=adaptive)
        self.joint_l3 = TCN_GCN_unit(128, 128, A, adaptive=adaptive)
        self.joint_l4 = TCN_GCN_unit(128, 256, A, adaptive=adaptive)
        self.joint_l5 = TCN_GCN_unit(256, 256, A, stride=2, adaptive=adaptive)
        ...
        self.bone_l1 = TCN_GCN_unit(in_channels, 64, A, residual=False, adaptive=adaptive)
        self.bone_l2 = TCN_GCN_unit(64, 128, A, adaptive=adaptive)
        self.bone_l3 = TCN_GCN_unit(128, 128, A, adaptive=adaptive)
        self.bone_l4 = TCN_GCN_unit(128, 256, A, adaptive=adaptive)
        self.bone_l5 = TCN_GCN_unit(256, 256, A, stride=2, adaptive=adaptive)
        ...
        self.jointmotion_l1 = TCN_GCN_unit(in_channels, 64, A, residual=False, adaptive=adaptive)
        self.jointmotion_l2 = TCN_GCN_unit(64, 128, A, adaptive=adaptive)
        self.jointmotion_l3 = TCN_GCN_unit(128, 128, A, adaptive=adaptive)
        self.jointmotion_l4 = TCN_GCN_unit(128, 256, A, adaptive=adaptive)
        self.jointmotion_l5 = TCN_GCN_unit(256, 256, A, stride=2, adaptive=adaptive)
        ...
        self.bonemotion_l1 = TCN_GCN_unit(in_channels, 64, A, residual=False, adaptive=adaptive)
        self.bonemotion_l2 = TCN_GCN_unit(64, 128, A, adaptive=adaptive)
        self.bonemotion_l3 = TCN_GCN_unit(128, 128, A, adaptive=adaptive)
        self.bonemotion_l4 = TCN_GCN_unit(128, 256, A, adaptive=adaptive)
        self.bonemotion_l5 = TCN_GCN_unit(256, 256, A, stride=2, adaptive=adaptive)
    ...
    def forward(self, x):
        ...
        joint = self.data_bn(joint)
        bone = self.data_bn(bone)
        jointmotion = self.data_bn(jointmotion)
        bonemotion = self.data_bn(bonemotion)
        ...
        outputs = self.drop_out(joint + bone + jointmotion + bonemotion)
