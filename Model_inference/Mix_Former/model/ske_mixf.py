...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=3):
        ...
        time_channels = 300
        self.l1 = Ske_MixF(base_channel, base_channel, A, time_channels, residual=False)
        self.l2 = Ske_MixF(base_channel, base_channel, A, time_channels)
        self.l3 = Ske_MixF(base_channel, base_channel, A, time_channels)
        self.l4 = Ske_MixF(base_channel, base_channel, A, time_channels)
        self.l5 = Ske_MixF(base_channel, base_channel*2, A, time_channels//2, stride=2)
        self.l6 = Ske_MixF(base_channel*2, base_channel*2, A, time_channels//2)
        self.l7 = Ske_MixF(base_channel*2, base_channel*2, A, time_channels//2)
        self.l8 = Ske_MixF(base_channel*2, base_channel*4, A, time_channels//4, stride=2)
        self.l9 = Ske_MixF(base_channel*4, base_channel*4, A, time_channels//4)
        self.l10= Ske_MixF(base_channel*4, base_channel*4, A, time_channels//4)
    ...
    def forward(self, x):
        ...
        x = x.reshape(N, M, self.base_channel*4, -1)
        x = x.mean(3).mean(1)
