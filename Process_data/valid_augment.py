...
N, C, T, V, M = 2000, 3, 300, 17, 2 # N为取的样本数

train_data_path = "/data2/songxinshuai/ICMEW2024-Track10/Process_data/data/val_joint.npy"
train_label_path = "/data2/songxinshuai/ICMEW2024-Track10/Process_data/data/val_label.npy"
...
valid_data_xyz,valid_label_xyz = load_train_data()
# valid_data_xy = valid_data_xyz[:,:2,:,:,:]



print(valid_data_xyz.shape)
# print(valid_data_xy.shape)
print(valid_label_xyz.shape)
# augmented_data , augmented_labels = generate_augmented_data_with_edges(train_data,train_label, augmentation_factor=1)

# valid_data , valid_labels = generate_augmented_data_with_edges(valid_data_xyz,valid_label_xyz)

save_processed_data(valid_data_xyz,'/data2/songxinshuai/ICMEW2024-Track10/Process_data/augment/mean_norm/valid_joint.npy')
save_processed_data(valid_label_xyz,'/data2/songxinshuai/ICMEW2024-Track10/Process_data/augment/mean_norm/valid_label.npy')
# save_processed_data(valid_label_xyz,'/data2/songxinshuai/behaviour/ICMEW2024-Track10/Model_inference/Mix_GCN/processed_data/valid_joint_label.npy')
